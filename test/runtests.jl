...
# !!! Main.UserApp is configured as an alias for Main.IzumiUtil and you might encounter it in some tests
using Main.IzumiUtil, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "IzumiUtil tests" begin
  @includetests ARGS
end
